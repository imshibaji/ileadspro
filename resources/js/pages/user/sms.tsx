...
export default function Sms() {
    ...
    return (
        <AppLayout breadcrumbs={breadcrumbs}>
            <Head title="SMS Sender" />
            <div className="flex h-full flex-1 flex-col gap-4 rounded-xl p-4">
                <div className="grid auto-rows-min gap-4 md:grid-cols-3">
                    <div className="border-sidebar-border/70 dark:border-sidebar-border relative aspect-video overflow-hidden rounded-xl border">
                        <AppCard title="SMS Campaigns">
                            <div className="flex flex-col items-center align-middle gap-2">
                                ...
                                <h4 className="text-lg font-bold text-accent-foreground">Mobile SMS Campaigns</h4>
                            </div>
                        </AppCard>
                    </div>
                    <div className="border-sidebar-border/70 dark:border-sidebar-border relative aspect-video overflow-hidden rounded-xl border">
                        <AppCard title="SMS Campaigns">
                            <div className="flex flex-col items-center align-middle gap-2">
                                <h3 className="text-lg font-bold text-accent-foreground">SMS Sent</h3>
                    ...
                    <div className="border-sidebar-border/70 dark:border-sidebar-border relative aspect-video overflow-hidden rounded-xl border">
                        <AppCard title="SMS Balance">
                            <div className="flex flex-col items-center align-middle gap-2">
                                <h3 className="text-lg font-bold text-accent-foreground">Balance</h3>
                                <h1 className="text-6xl font-bold text-accent-foreground">2000</h1>
                                <h4 className="text-lg font-bold text-accent-foreground">SMS Balance</h4>
                            </div>
                        </AppCard>
                    </div>
                </div>
                <div className="border-sidebar-border/70 dark:border-sidebar-border relative min-h-[100vh] flex-1 overflow-hidden rounded-xl border md:min-h-min">
                    <AppCard title="SMS Campaigns" header={
